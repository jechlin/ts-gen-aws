...
class ConversionSettings {
    ...
    public Settings toSettings() {
        final URLClassLoader classLoader = Settings.createClassLoader("dummy", [] as URL[], Thread.currentThread().getContextClassLoader())
        ...
        settings.npmName = npmName == null && generateNpmPackageJson ? "dummy" : npmName
